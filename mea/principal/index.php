		...
		<form>
            ...
            <fieldset id="content-box">
                ...
                <div id="text">
                    ...
                    <div class="list-box">
                        <a href="novoaluno.php"><button class="button-list" type="button">Cadastrar novo aluno</button></a><br/>
                        <a href="editaraluno.php"><button type="button" class="button-list">Editar cadastros</button></a><br/>
